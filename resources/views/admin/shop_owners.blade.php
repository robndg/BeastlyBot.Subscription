                        ...
                        <tr id="admin_table_">
                            ...
                            <td class="cell-400 pl-15">
                                <div class="content text-left">
                                    <h4><span class="badge badge-{{ $shop->live ? 'success' : 'primary' }}">{{ $shop->live ? 'Live' : 'Test' }}</span>  <a href="{{ BeastlyConfig::get('APP_URL') }}{{ BeastlyConfig::get('SHOP_URL') }}/{{ $shop->url }}">{{ $shop->url }}</a></h4>

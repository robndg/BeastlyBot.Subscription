...
<link rel="stylesheet" href="{{ asset('dash/assets/vendor/@icon/dripicons/dripicons.css') }}">
<link rel='stylesheet' href="{{ asset('dash/assets/vendor/fullcalendar/core/main.css') }}" />
<link rel='stylesheet' href="{{ asset('dash/assets/vendor/fullcalendar/daygrid/main.css') }}" />
<link rel='stylesheet' href="{{ asset('dash/assets/vendor/fullcalendar/timegrid/main.css') }}" />

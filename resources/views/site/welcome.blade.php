                ...
                <div class="col-lg-6 col-md-6 order-1 order-md-2">
                    ...
                    <div class="banner-caption pt-50 pt-sm-none">
                        ...
                        <div class="banner-action wow fadeInUp" data-wow-delay=".3s" style="visibility:hidden">
                            ...
                            @else
                                <a href="https://discordapp.com/api/oauth2/authorize?client_id=590725202489638913&redirect_uri={{ env('DISCORD_AUTH_REDIRECT') }}&response_type=code&scope=identify%20email%20guilds%20guilds.join" class="btn-common radius-50 btn-pink mr-20">Create Shop</a>
                            @endauth
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ds-sm-none wow zoomIn">
                        <div class="pricing-table-single wow fadeIn" data-wow-delay=".3s">
                            ...
                            <div class="pricing-table-body">
                                ...
                                @else
                                <a href="https://discordapp.com/api/oauth2/authorize?client_id=590725202489638913&redirect_uri={{ env('DISCORD_AUTH_REDIRECT') }}&response_type=code&scope=identify%20email%20guilds%20guilds.join" class="btn-common">Get Started</a>
                                @endauth
                            </div>
                        </div>
                    </div>

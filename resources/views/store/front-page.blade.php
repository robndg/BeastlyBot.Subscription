...
<div class="section integration-page">
            <div class="container-large-1040px">
               ...
               <div data-w-id="3e7a78ef-77f6-6e11-e17e-da3aa1a04313" style="-webkit-transform:translate3d(0, 20px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 20px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 20px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 20px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);" class="integration-tabs-menu w-tab-menu">
                        <a data-w-tab="Tab 1" class="integration-tab-link w-inline-block w-tab-link tab-block w--current" onclick="showBlock('store-description-block')" data-target-block="store-description-block">
                           <div>Description</div>
                        </a>
                        <a data-w-tab="Tab 2" class="integration-tab-link w-inline-block w-tab-link tab-block" onclick="showBlock('store-products-block')" data-target-block="store-products-block">
                           <div>Products</div>
                        </a>
                        <a data-w-tab="Tab 3" class="integration-tab-link w-inline-block w-tab-link tab-block">
                           <div>Referalls</div>
                        </a>
                     </div>
...
<div class="w-dyn-list"><div role="list" class="more-openings-grid w-dyn-items"><div data-w-id="8116e32d-45f9-b5ec-fa48-53777bb1af4d" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); opacity: 1; transform-style: preserve-3d;" role="listitem" class="w-dyn-item"><a href="/job/jr-frontend-developer" aria-current="page" class="card job-opening-v1 w-inline-block w--current" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"><div class="top-content job-opening-v1"><div class="split-content job-opening-v1-left"><div>Remote</div><div class="job-opening-v1-about-divider"></div><div>Full Time</div></div><div class="badge job-opening-v1">Developer</div></div><h3 class="title job-opening-v1">Jr Frontend Developer</h3><p class="paragraph job-opening-v1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut morbi nibh et, ullamcorper ultricies. Vitae platea arcu nulla eu pharetra in.</p><div class="button-primary job-opening-v1">Apply Now</div></a></div><div data-w-id="8116e32d-45f9-b5ec-fa48-53777bb1af4d" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); opacity: 1; transform-style: preserve-3d;" role="listitem" class="w-dyn-item"><a href="/job/ui-ux-and-product-designer" class="card job-opening-v1 w-inline-block" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"><div class="top-content job-opening-v1"><div class="split-content job-opening-v1-left"><div>Remote</div><div class="job-opening-v1-about-divider"></div><div>Full Time</div></div><div class="badge job-opening-v1">Design</div></div><h3 class="title job-opening-v1">UI/UX and Product Designer</h3><p class="paragraph job-opening-v1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut morbi nibh et, ullamcorper ultricies. Vitae platea arcu nulla eu pharetra in.</p><div class="button-primary job-opening-v1">Apply Now</div></a></div></div></div>
               ...
               <div data-w-id="0e53f2b7-9467-6285-9db7-c8917faec362" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); opacity: 1; transform-style: preserve-3d;" class="teams-v1-tabs-menu w-tab-menu" role="tablist">
                    <a data-w-tab="Tab 1" class="teams-v1-tab-link w-inline-block w-tab-link" id="w-tabs-0-data-w-tab-0" href="#w-tabs-0-data-w-pane-0" role="tab" aria-controls="w-tabs-0-data-w-pane-0" aria-selected="false" tabindex="-1">
                        <div>Guild Access</div>
                    </a>
                    <a data-w-tab="Tab 2" class="teams-v1-tab-link w-inline-block w-tab-link w--current" id="w-tabs-0-data-w-tab-1" href="#w-tabs-0-data-w-pane-1" role="tab" aria-controls="w-tabs-0-data-w-pane-1" aria-selected="true">
                        <div>Everyone</div>
                    </a>
                    <a data-w-tab="Tab 3" class="teams-v1-tab-link w-inline-block w-tab-link" tabindex="-1" id="w-tabs-0-data-w-tab-2" href="#w-tabs-0-data-w-pane-2" role="tab" aria-controls="w-tabs-0-data-w-pane-2" aria-selected="false">

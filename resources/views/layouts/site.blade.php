                ...
                <div class="col-lg-8 col-md-6 col-3">
                    <div class="d-flex header-right pull-right">
                        ...
                        <button class="btn radius-50 help-line style-2">
                            ...
                            @else
                                <a href="{{ ('https://discordapp.com/api/oauth2/authorize?client_id=' . SiteConfig::get('DISCORD_CLIENT_ID') . '&redirect_uri=' . SiteConfig::get('APP_URL') . SiteConfig::get('DISCORD_AUTH_REDIRECT') . '&response_type=code&scope=' . SiteConfig::get('DISCORD_OAUTH_SCOPE')) }}">

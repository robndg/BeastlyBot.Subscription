            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 offset-lg-2 text-center">
                    <div class="list-group">
                        <a class="list-group-item list-group-item-action flex-column align-items-start text-center" href="{{ 'https://connect.stripe.com/express/oauth/authorize?redirect_uri=' . SiteConfig::get('APP_URL') . '&client_id=' . SiteConfig::get('STRIPE_CLIENT_ID')  }}">

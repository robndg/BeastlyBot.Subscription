...
class Refund extends Model
{
   ...
   // public $incrementing = false;
    ...
    public static function create($sub_id, $sub_start_date, $sub_period_end, $sub_user_id, $owner_id, $sub_stripe_account_id, $sub_guild_name, $sub_role_name, $sub_guild_id, $sub_role_id, $sub_refund_enabled, $sub_refund_days, $sub_refund_terms, $sub_description, $sub_plan_id, $sub_amount, $sub_application_fee) {
